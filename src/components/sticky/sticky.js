...
class Sticky extends Component {
  ...
  fillSvg() {
    ...
    if (!isMobile) {
      return (
        <svg width="491" height="368" viewBox="0 0 491 368" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M70 298.5V298H69.5H0.5V0.5H490.5V367.5H70V298.5ZM69 299V366.793L1.2071 299H69Z" fill="#E8DE6F" strokeWidth="1px" />
          <path d="M70 298.5V298H69.5H0.5V0.5H490.5V367.5H70V298.5ZM69 299V366.793L1.2071 299H69Z" stroke="black" />
        </svg>
