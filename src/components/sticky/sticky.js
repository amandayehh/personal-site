    ...
    return (
      <div className="sticky">
        <div className="sticky__bio">
          ...
          <h3 className="sticky__bio__2" >Open to work on weird things. Just <span className="serif"> <a id="sticky__bio_a" href="mailto:ayeh01@mica.edu" target="_blank">reach out</a></span>!</h3>
