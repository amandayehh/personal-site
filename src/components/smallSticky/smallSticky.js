  ...
  render() {
    return (
      <div className="smallSticky">
        <p className="smallSticky__text"><BubbleContainer as="a" className="smallSticky__text__link" href="mailto:amandayeh@proton.me" variant="dramatic" underline leaveDuration={1300}>Email me</BubbleContainer> for personal use of typefaces.</p>
