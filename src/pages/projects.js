...
const sections = [
  {
    ...
    items: [
      ...
      { name: "Voices and Voices", description: "Website for voice assistant vignettes", tags: ["Framer", "Framer", "Framer"] },
      { name: "Synesthetic perceptions", description: "Website with audio and visual compositions", tags: ["Framer", "Framer", "Framer"] },
    ],
  },
  {
    title: "Games",
    items: [
      { name: "BOY♡GAME", description: "Analog and digital boy-dating game", tags: ["Framer", "Framer", "Framer"] },
      { name: "Say no more, Semaphore", description: "Semaphore education game", tags: ["Framer", "Framer", "Framer"] },
      { name: "Buncho the Lost Bird", description: "UI/UX for 3D adventure game", tags: ["Framer", "Framer", "Framer"] },
    ],
  },
  {
    title: "Tools",
    items: [
      { name: "Figma", description: "Design for Figma editor, design system, and sites", tags: ["Framer", "Framer", "Framer"] },
      { name: "Keyboard Doodler", description: "Keyboard-based vectorizer", tags: ["Framer", "Framer", "Framer"] },
    ],
  },
  {
    title: "Typefaces",
    items: [
      { name: "Cork", description: "Humanist variable display typeface", tags: ["Framer", "Framer", "Framer"] },
      { name: "Cloister Revival", description: "Old-style serif typeface revival", tags: ["Framer", "Framer", "Framer"] },
      { name: "Cycle", description: "Industrial grotesque font digitization", tags: ["Framer", "Framer", "Framer"] },
    ],
  },
  {
    title: "Products",
